...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Deletar', true), array('action' => 'delete', $this->Form->value('Pagina.id')), null, sprintf(__('Tem certeza que deseja deletar a página %s?', true), $this->Form->value('Pagina.titulo'))); ?></li>
