...
<div class="subpaginas form">
<?php echo $this->Form->create('Subpagina');?>
	<fieldset>
 		<legend><?php __('Editar Subpágina'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('pagina_id', array('label'=>'Página'));
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Subpagina.id')), null, sprintf(__('Tem certeza que deseja deletar a subpágina %s?', true), $this->Form->value('Subpagina.titulo'))); ?></li>
